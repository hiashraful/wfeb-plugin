...
$coach_registration_page_id = get_option( 'wfeb_coach_registration_page_id' );
if ( $coach_registration_page_id ) {
	$coach_registration_url = get_permalink( $coach_registration_page_id );
}
...
<head>
	...
	<title><?php echo esc_html__( 'Coach Login - WFEB', 'wfeb' ); ?></title>
...
<body class="wfeb-page">
	...
	<div class="wfeb-auth-container">
		...
		<div class="wfeb-auth-card">
			...
			<h2 class="wfeb-auth-title"><?php echo esc_html__( 'Coach Login', 'wfeb' ); ?></h2>
			<p class="wfeb-auth-subtitle"><?php echo esc_html__( 'Sign in to your coaching dashboard', 'wfeb' ); ?></p>

			<div id="wfeb-login-notice" class="wfeb-notice" style="display:none;"></div>

			<form id="wfeb-coach-login-form" class="wfeb-form" method="post" novalidate>

				<input type="hidden" name="action" value="wfeb_coach_login">
		...
		<?php if ( $coach_registration_url ) : ?>
			<div class="wfeb-auth-links">
				<?php echo esc_html__( "Don't have an account?", 'wfeb' ); ?>
				<a href="<?php echo esc_url( $coach_registration_url ); ?>">
					<?php echo esc_html__( 'Register as a Coach', 'wfeb' ); ?>
				</a>
			</div>
		<?php endif; ?>
